...
public class Backend {
	...
	/**
	 * So we don't have to parse a file again. This will use irCode from a Basic
	 * Block.
	 * 
	 */
	public Backend() {
	...
	private String loadStoreVar(String loadOrStore, String var) {
		...
		if (isVariable) {
			...
			irNodes.add(new IRnode(loadOrStore, register, variable.stackOffset
					+ STACK_POINTER));
		}
	...
	private void addBranch(Scanner lineScanner, String operation) {
		...
		String op = operation.substring(0, operation.indexOf(",")); // removes
																	// the
																	// commas
																	// from the
																	// branch OP
	...
	private class Variable {
		...
		public boolean equals(Object o) {
			...
			if (o instanceof Variable && varName.equals(compareTo.varName)
					&& stackOffset == compareTo.stackOffset)
				return true;
			else
				return false;
